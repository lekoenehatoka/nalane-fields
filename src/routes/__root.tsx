...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nalane Fields is a 100% Black woman-owned sheep farm near Bloemfontein, raising premium grass-fed Dorper sheep with care, transparency, and sustainability." },
      { name: "author", content: "Nalane Fields" },
      { property: "og:title", content: "Nalane Fields — Ethical Sheep Farming" },
      { property: "og:description", content: "Premium grass-fed Dorper sheep from Bloemfontein Rural, Free State." },
